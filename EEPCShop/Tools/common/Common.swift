...
public let longiduteKey:String = "JDY_longidute"
public let latitudeKey:String = "JDY_latitude"

public let CITY:String = "JDY_CITY"
public let ADDRESS:String = "JDY_ADDRESS"

//用户信息
//let httpUrl = "http://tang11ers.tpddns.cn:8064"
//let httpUrl = "http://shop.ui-token.com"
let httpUrl = "http://shop.shijihema.cn"


//XKChian
public let TOKEN = "JDY_token"
public let UITOKEN_UID = "UITOKEN_UID"
public let UITOKEN_COUPOM = "UITOKEN_COUPOM"

public let UITOKEN_PHONE = "UITOKEN_PHONE"

public let ISSHOP = "is_shop"


public let PGYer_ID: String = "3293a1527fa61b5589c6c135b8d35c21"

public let JPushAppKey:String = "240fc3f87896d724b69c464a"
//百度
//public let AK: String = "GBc03gFz7w0efnUoaLwcwFZwejHkj441"
public let AK: String = "ydbwuZDllcDze6hN6IRincb4OhLEzvLd"  //苹果商店
...
let  LL_StatusBarHeight : CGFloat =  ((isiPhoneX || isiPhoneXR)  ? 44.0 : 20.0)

let  LL_Extra : CGFloat =  ((isiPhoneX || isiPhoneXR)  ? 48.0 : 0)

let  LL_ExtraDes : CGFloat =  ((isiPhoneX || isiPhoneXR)  ? 20.0 : 0)

let  LL_keyboard : CGFloat = ((isiPhoneX || isiPhoneXR)  ?  76.0 : 0.0)
