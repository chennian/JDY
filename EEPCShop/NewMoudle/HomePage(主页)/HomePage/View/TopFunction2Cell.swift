...
class TopFunction2Cell: SNBaseTableViewCell {
    ...
    func bindEvent(){
        ...
        coupon.addGestureRecognizer(tap2)
        map.addGestureRecognizer(tap3)
        service.addGestureRecognizer(tap4)
