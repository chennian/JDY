...
extension RegisterViewController {
    ...
    override func setupView() {
        ...
        serviceView.set(image: "agree", selectImage: "agree1", desc: "我已阅读并同意以下协议", serviceButtonText: "验证码")
...
//            SZHUD("请填写二级密码", type: .info, callBack: nil)
//            return
//        }
//        if confirmPayPwdView.textField.text! == "" {
//            SZHUD("请填写确认二级密码", type: .info, callBack: nil)
//            return
//        }
//
//        if payPwdView.textField.text != confirmPayPwdView.textField.text {
//            SZHUD("二级密码不一致", type: .info, callBack: nil)
//            return
//        }
