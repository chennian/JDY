...
class UserToolView: SNBaseView {
    ...
    let shopManagerButton = UIButton().then{
        $0.setImage(UIImage(named: "iconb"), for: .normal)
        $0.isUserInteractionEnabled = false
    }
    ...
    let serviceButton = UIButton().then{
        $0.setImage(UIImage(named: "iconc"), for: .normal)
        $0.isUserInteractionEnabled = false
    }
    ...
    let videoButton = UIButton().then{
        $0.setImage(UIImage(named: "icond"), for: .normal)
        $0.isUserInteractionEnabled = false
    }
