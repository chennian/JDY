...
class FourCell: SNBaseTableViewCell {
    ...
    var model:ShopMsgModel?{
        didSet{
            ...
            self.shopHeadView.img.image = UIImage(named: "me_img")
            self.shopHeadView.address.text = "地址:暂未设置"
...
//        $0.backgroundColor = Color(0x005eb7)
    ...
    override func setupView() {
        ...
        self.contentView.addSubview(self.rmdToolView)
