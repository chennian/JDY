...
class BankTypeCell: SNBaseTableViewCell {
    ...
    var cellModel:BindingModel?{
        didSet{
            ...
            bank_type.text = model.bank_type
            bank_branch.text = model.bank_branch
            
                        
            bank_no.text = model.bank_no.formateForBankCard()
            
            
            
            holdPerson.text = model.bank_name
